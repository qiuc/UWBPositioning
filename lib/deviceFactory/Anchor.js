...
var trilateration   = require('../mathTools/trilateration');
        ...
        switch(positionIds.length) {
            ...
            case 2:
                if(validIds.length === 2) {
                    ...
                    if(d1 > 0 && d2 > 0) {
                        this.position = trilateration(p1, p2, d1, d2, 0.05, settings.isMirror);
                    }
                }
                break;
            case 3:
                ...
                break;
            default:
                var err = new Error("positioning only support 4 anchors.");
                err.code = "ANCHOR_TOO_MORE_DISTANCES";
                throw err;
        }
    }
